...
@synthesize messageIsGroupDelete = _messageIsGroupDelete;
@synthesize messageContactAnnear = _messageContactAnnear;
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    _messageInfo_Copy.messageIsGroupDelete = self.messageIsGroupDelete;
    _messageInfo_Copy.messageContactAnnear = [self.messageContactAnnear copyWithZone:zone];
