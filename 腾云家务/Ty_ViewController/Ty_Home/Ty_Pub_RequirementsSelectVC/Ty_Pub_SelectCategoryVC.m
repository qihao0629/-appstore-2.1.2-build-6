...
@interface Ty_Pub_SelectCategoryVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation Ty_Pub_SelectCategoryVC
...
- (void)viewDidLoad
{
    ...
    if ([workPlist count]>0) {
        ...
        //        [tableView2_.delegate tableView:tableView2_ didSelectRowAtIndexPath:firstPath];
//        if ([arrContent2 count]>0) {
//            self.xuqiuInfo.workName = [[arrContent2 objectAtIndex:0]objectForKey:@"workName"];
//            self.xuqiuInfo.workGuid = [[arrContent2 objectAtIndex:0] objectForKey:@"workGuid"];
//        }
    }
...
//        }
    ...
    if (tableView == tableView2_) {
        if ([arrContent2 count]>0) {
            if (![self.xuqiuInfo.workName isEqualToString:[[arrContent2 objectAtIndex:indexPath.row]objectForKey:@"workName"]]) {
                ...
                self.xuqiuInfo.usedCouponInfo.couponGuid = @"";
                self.xuqiuInfo.usedCouponInfo.couponTitle = @"";
                self.xuqiuInfo.usedCouponInfo.couponCutPrice =@"";
            }
